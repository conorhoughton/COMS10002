...
\item [10 marks] Solve for $T(n)$ using the ansatz $T(n)=r^n$ for the following
...
\item [15 marks] This question is about the master theorem. Use it to calculate big-Theta for $T(n)$ in each case
...
\item [20 marks] For one of the folr based algorithms, you looked at
  in last week's Haskell work sheet, work out the asymptotic
  complexity.

\item [20 marks] In the section 1\_introduction the actual run time
  ...
  are provided in the 1\_introduction folder.
